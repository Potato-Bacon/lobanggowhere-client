  ...
  return (
    ...
    >
      <div className="flex items-center justify-center p-28">
        <div className="bg-white bg-opacity-20 backdrop-blur-md rounded-xl drop-shadow-lg shadow-2xl flex-col flex items-center justify-center px-8 py-8 sm:px-12 lg:col-span-7 lg:py-12 lg:px-16 xl:col-span-6">
          ...
          >
            ...
            <div className="col-span-6 sm:flex sm:items-center sm:gap-4">
              ...
              <p className="mt-4 text-sm text-black sm:mt-0 font-serif font-bold">
